...
<head>
    ...
    <title>BacaBuku! - Edit Kategori</title>
    ...
    <main>
        ...
        <div class="album py-5 bg-light">
            <div class="container-sm">
                <h4 class="text-center" style="text-transform: uppercase; letter-spacing: 2.5px;">Edit Kategori</h4>
                <form action="../proses.php?aksi=edit_kategori" method="POST" enctype="multipart/form-data" class="mt-5">
                    <?php
                    foreach ($db->edit_kategori($_GET['id_kategori']) as $data) {
                    ?>
                        <div class="mb-3">
                            <input type="hidden" name="id_kategori" value="<?php echo $data['id_kategori'] ?>">
                            <label for="kategori" class="form-label">Kategori</label>
                            <input type="text" name="kategori" placeholder="Kategori" class="form-control" id="kategori" value="<?php echo $data['kategori'] ?>" required>
                        </div>
                        <div class="my-4">
