...
<head>
    ...
    <title>BacaBuku! - Daftar Kategori</title>
...
<body>
    ...
    <main>
        ...
        <div class="album py-5 bg-light">
            <div class="container">
                <h4 class="text-center" style="text-transform: uppercase; letter-spacing: 2.5px;">Daftar Kategori</h4>
                <table class="table table-hover mt-5">
                    ...
                    $no = 1;
                    //Menampilkan data
                    foreach ($db->tampil_data_kategori("SELECT * FROM kategori ORDER BY kategori ASC") as $data) {
                    ?>
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <a href="../admin/edit_kategori.php?id_kategori=<?php echo $data['id_kategori']; ?>&aksi=edit_kategori">
                                        <button type="button" class="btn btn-sm btn-outline-secondary">Edit</button>
                                    </a>
                                    <a href="../proses.php?id_kategori=<?php echo $data['id_kategori']; ?>&aksi=hapus_kategori">
                ...
                <div class="my-4 d-md-flex justify-content-md-end">
                    <form action="../admin/input_kategori.php" method="POST" enctype="multipart/form-data">
